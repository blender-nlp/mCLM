...
pth = '/shared/nas2/chihan3/mCLM/drug_improving_baselines/v2_output/{}/baseline_{}.pkl'

for base in ['claude_claude-3-5-haiku-latest']:#['chatgpt_gpt-4o', 'chatgpt_gpt-5', 'claude_claude-3-5-haiku-latest', 'google_genai_gemini-2.5-flash', 'ldmol']:
    print(base)
